...
# Dodałem "steps_only" do listy, żeby logika rozpoznała to jako ćwiczenie z udziałem nóg
LEG_EXERCISES = ("step_only", "steps_only", "full")
...
class RepetitionSegmenter:
    ...
    # NOWA METODA: Pozwala na zmianę ćwiczenia w trakcie działania programu
