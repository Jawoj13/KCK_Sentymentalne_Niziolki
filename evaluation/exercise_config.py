...
# Aliasy dla bezpieczeństwa i komunikacji z UI
EXERCISE_CONFIG["steps_only"] = EXERCISE_CONFIG["step_only"]
EXERCISE_CONFIG["default"] = EXERCISE_CONFIG["full"]

ERROR_PRIORITIES = {
	"arms_only": {
		"ARM_NOT_EXTENDED": 0.5,
		"WINDUP": 1.3,
...
# Aliasy dla błędów
ERROR_PRIORITIES["steps_only"] = ERROR_PRIORITIES["step_only"]
ERROR_PRIORITIES["default"] = ERROR_PRIORITIES["full"]
